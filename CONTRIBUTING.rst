...
Ready to contribute? Here's how to set up `mlconjug3` for local development.

1. Fork the `mlconjug3` repo on GitHub.
...
3. The pull request should work for Python 3.3, 3.4, 3.5 and 3.6. Check
   https://travis-ci.org/ArsLinguistica/mlconjug3/pull_requests
